...
function(ConfigPackage PACKAGE VERSION ID_PREFIX)
    ...
    if(EXISTS "${PROJECT_TEMPLATE_DIR}/desktop_file.desktop.in")
        configure_file("${PROJECT_TEMPLATE_DIR}/desktop_file.desktop.in" "${PROJECT_BINARY_DIR}/${PACKAGE}.desktop" @ONLY)
    endif()
    
    if(EXISTS "${PROJECT_TEMPLATE_DIR}/pkgconfig.pc.in")
        configure_file("${PROJECT_TEMPLATE_DIR}/pkgconfig.pc.in" "${PROJECT_BINARY_DIR}/pkgconfig/${PACKAGE}.pc" @ONLY)
    endif()
