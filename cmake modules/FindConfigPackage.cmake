...
function(ConfigPackage PACKAGE VERSION ID_PREFIX)
    ...
    if(ARCH STREQUAL "i386" OR ARCH STREQUAL "32")
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -m32" PARENT_SCOPE)
        set(CMAKE_CXX_LINK_FLAGS "${CMAKE_CXX_LINK_FLAGS} -m32" PARENT_SCOPE)
        set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -m32" PARENT_SCOPE)
        set(CMAKE_C_LINK_FLAGS "${CMAKE_C_LINK_FLAGS} -m32" PARENT_SCOPE)
        set(FIND_LIBRARY_USE_LIB64_PATHS "OFF" PARENT_SCOPE)
    elseif(ARCH STREQUAL "amd64" OR ARCH STREQUAL "64")
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -m64" PARENT_SCOPE)
        set(CMAKE_CXX_LINK_FLAGS "${CMAKE_CXX_LINK_FLAGS} -m64" PARENT_SCOPE)
        set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -m64" PARENT_SCOPE)
        set(CMAKE_C_LINK_FLAGS "${CMAKE_C_LINK_FLAGS} -m64" PARENT_SCOPE)
    endif()
